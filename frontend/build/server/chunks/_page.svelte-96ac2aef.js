...
const ImageContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-container svelte-25w0vb"><h1 class="image-title general-header svelte-25w0vb"><i class="fa-solid fa-image"></i>
	...
	<img class="image-content svelte-25w0vb" src="${"http://localhost:4200/uploads/" + escape(image.filename, true)}" alt="">
...
const CommentForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<form class="comment-form svelte-15ht31p" action="${"http://localhost:4200/api/" + escape(id, true) + "/comment"}" method="POST">${see ? `${slots.default ? slots.default({}) : ``}` : ``}
...
//# sourceMappingURL=_page.svelte-96ac2aef.js.map
