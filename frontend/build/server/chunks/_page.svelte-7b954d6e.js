...
const Upload = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="upload-body svelte-n1bbjm"><form action="http://localhost:4200/api/upload" method="POST" enctype="multipart/form-data">${visible ? `<div class="upload-box svelte-n1bbjm">${slots.default ? slots.default({}) : ``}</div>` : ``}
...
//# sourceMappingURL=_page.svelte-7b954d6e.js.map
