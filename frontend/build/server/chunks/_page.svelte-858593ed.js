...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="principal-container svelte-vn5th8">${validate_component(Upload, "Upload").$$render(
	...
	<div class="upload-sidebar svelte-vn5th8">${validate_component(Stats, "Stats").$$render($$result, { stats: data.stats }, {}, {})}
		${validate_component(ViewedImages, "ViewedImages").$$render($$result, { images: data.viewedImages }, {}, {})}
		${validate_component(RecentComments, "RecentComments").$$render($$result, { comments: data.recentComments }, {}, {})}</div>
	<div class="upload-recent svelte-vn5th8">${validate_component(RecentUploads, "RecentUploads").$$render($$result, { images: data.images }, {}, {})}</div>
</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-858593ed.js.map
